...
func (x *Payload) GetControl() *ActuatorControl {
	if x, ok := x.GetPayload().(*Payload_Control); ok {
		return x.Control
	}
	return nil
}
...
type Payload_Control struct {
	Control *ActuatorControl `protobuf:"bytes,2,opt,name=control,proto3,oneof"`
}
...
func (*Payload_Control) isPayload_Payload() {}
...
var file_message_protocol_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xa0, 0x02, 0x0a, 0x07, 0x50, 0x61, 0x79,
	...
	0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x12, 0x34, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74,
	0x72, 0x6f, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x2e, 0x41, 0x63, 0x74, 0x75, 0x61, 0x74, 0x6f, 0x72, 0x43, 0x6f, 0x6e, 0x74,
	0x72, 0x6f, 0x6c, 0x48, 0x00, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x12, 0x41,
...
var file_message_protocol_proto_depIdxs = []int32{
	...
	6,  // 6: message.Payload.control:type_name -> message.ActuatorControl
