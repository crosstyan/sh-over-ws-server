...
type Payload struct {
	...
	//
	//	*Payload_Handshake
	//	*Payload_ControlActuator
	//	*Payload_ControlRequest
	//	*Payload_StdPayload
	//	*Payload_Error
...
func (x *Payload) GetHandshake() *Handshake {
	if x, ok := x.GetPayload().(*Payload_Handshake); ok {
		return x.Handshake
	}
	return nil
}

func (x *Payload) GetControlActuator() *ActuatorControl {
	if x, ok := x.GetPayload().(*Payload_ControlActuator); ok {
		return x.ControlActuator
	}
	return nil
}

func (x *Payload) GetControlRequest() *ControlRequest {
	if x, ok := x.GetPayload().(*Payload_ControlRequest); ok {
		return x.ControlRequest
	}
	return nil
}

func (x *Payload) GetStdPayload() *StdPayload {
	if x, ok := x.GetPayload().(*Payload_StdPayload); ok {
		return x.StdPayload
	}
	return nil
}
...
func (x *Payload) GetError() *Error {
	if x, ok := x.GetPayload().(*Payload_Error); ok {
		return x.Error
	}
	return nil
}
...
type Payload_Handshake struct {
	Handshake *Handshake `protobuf:"bytes,1,opt,name=handshake,proto3,oneof"`
}

type Payload_ControlActuator struct {
	ControlActuator *ActuatorControl `protobuf:"bytes,2,opt,name=controlActuator,proto3,oneof"`
}

type Payload_ControlRequest struct {
	ControlRequest *ControlRequest `protobuf:"bytes,3,opt,name=controlRequest,proto3,oneof"`
}

type Payload_StdPayload struct {
	StdPayload *StdPayload `protobuf:"bytes,4,opt,name=stdPayload,proto3,oneof"`
}
...
func (*Payload_Handshake) isPayload_Payload() {}

func (*Payload_ControlActuator) isPayload_Payload() {}

func (*Payload_ControlRequest) isPayload_Payload() {}

func (*Payload_StdPayload) isPayload_Payload() {}

func (*Payload_Error) isPayload_Payload() {}
...
var file_message_protocol_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_message_protocol_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_message_protocol_proto_goTypes = []interface{}{
	...
	(*Payload)(nil),             // 11: message.Payload
}
var file_message_protocol_proto_depIdxs = []int32{
	...
	5,  // 5: message.Payload.handshake:type_name -> message.Handshake
	6,  // 6: message.Payload.controlActuator:type_name -> message.ActuatorControl
	7,  // 7: message.Payload.controlRequest:type_name -> message.ControlRequest
	10, // 8: message.Payload.stdPayload:type_name -> message.StdPayload
	2,  // 9: message.Payload.error:type_name -> message.Error
...
func file_message_protocol_proto_init() {
	...
	file_message_protocol_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*Payload_Handshake)(nil),
		(*Payload_ControlActuator)(nil),
		(*Payload_ControlRequest)(nil),
		(*Payload_StdPayload)(nil),
		(*Payload_Error)(nil),
	}
	type x struct{}
